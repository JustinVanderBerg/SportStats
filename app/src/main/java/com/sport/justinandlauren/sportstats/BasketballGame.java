...
public class BasketballGame extends AbstractGame {
    ...
    /**
     * @return the totalShotsAttempted
     */
    ...
    /**
     * @param totalShotsAttempted the totalShotsAttempted to set
     */
